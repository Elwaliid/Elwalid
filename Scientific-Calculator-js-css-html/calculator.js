...
<table align="center">
    ...
    <tr>
        ...
        <td><button type="button" value="x^y" onclick="xy()"> x<sup>y </button> </td>
...
<script>
    ...
    function xy() {
    var base = parseFloat(document.calcul.result.value);
    var exponent = parseFloat(prompt("Enter the exponent (y):"));
